...
# default is used.
# Type: Directory
c.downloads.location.directory = '/home/acer/Downloads'
...
c.url.searchengines = {'DEFAULT': 'https://searx.be/search?q={}&language=all&time_range=&safesearch=0&categories=general'}
...
c.colors.completion.item.selected.bg = bg0_normal
...
c.colors.contextmenu.selected.bg = bg0_hard
...
c.colors.keyhint.fg = bright_orange
...
c.colors.statusbar.progress.bg = dark_aqua
