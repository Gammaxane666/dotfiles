...
static const char *dmenucmd[] = {"rofi","-terminal","alacritty","-show","drun","-icon-theme","Papirus","-show-icons"};
...
static const Key keys[] = {
    ...
    /* Volume */
	{ ControlMask|ShiftMask,        XK_Up,     spawn,          SHCMD("$HOME/.local/bin/DunstVol up")},
    ...
    /* Dmenu Scripts */
    {MODKEY|ShiftMask,              XK_l,      spawn,          SHCMD("$HOME/.config/suckless/dmenu/scripts/dm-logout")},
    {MODKEY|ShiftMask,              XK_c,      spawn,          SHCMD("$HOME/.config/suckless/dmenu/scripts/dm-confedit")},

    /* Switching Focus */
	{ MODKEY,                       XK_h,      focusstack,     {.i = +1 } },
	{ MODKEY,                       XK_l,      focusstack,     {.i = -1 } },

    /* Inc/Dec master window */
